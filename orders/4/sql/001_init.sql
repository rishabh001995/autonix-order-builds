-- Dedicated schema for Autonix order #4 — Deliveru. Do not share with other projects.
CREATE DATABASE IF NOT EXISTS `autonix_order_4`
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `category` VARCHAR(80) DEFAULT 'produce',
